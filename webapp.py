...
<style>
    ...
    /* 1. HEADER E CONTROLOS DO SISTEMA (Manter visíveis) */
    ...
    /* 2. SIDEBAR (Estilo Slate Dark) */
    [data-testid="stSidebar"] {
        background-color: #3d4450 !important;
        border-right: none;
    }
    
    /* FORÇAR TUDO NA SIDEBAR A BRANCO E NEGRITO (Sem exceções) */
    [data-testid="stSidebar"] * {
        color: #ffffff !important;
        font-weight: 700 !important;
    }

    /* Manter o botão de Sair vermelho (para o seletor acima não o "limpar") */
    [data-testid="stSidebar"] div.stButton > button:first-child {
        background: linear-gradient(135deg, #ff4b4b 0%, #d32f2f 100%) !important;
        color: white !important;
    }

    /* Caixa de Utilizador na Sidebar */
    ...
    /* Botão Vermelho na Sidebar (Sair) - FORÇADO */
    [data-testid="stSidebar"] div.stButton > button:first-child {
        background: linear-gradient(135deg, #ff4b4b 0%, #d32f2f 100%) !important;
        color: white !important;
        ...
        opacity: 1 !important; /* Garante que não herda transparências */
    }
    ...
    /* 4. BOTÃO DE ANÁLISE (Ciano Vibrante) */
    ...
    /* 5. ÁREA DE UPLOAD (Clean Light Blue) */
   ...
   /* 5. UNIFICAR O BOTÃO BROWSE FILES (VERSÃO FORÇADA) */
    /* Atacamos o parágrafo e o botão dentro do componente de upload */
    ...
    /* Forçar a cor do texto dentro do botão para branco */
...
aba1, aba2, aba3, aba_historico = st.tabs(["🔍 Análise Individual", "📦 Análise em Bulk", "📰 Radar de Mercado","📜 Histórico"])
